...
<div class="RegMain">
	...
	<button type="submit" onclick="form.action='<c:url value="/memberUp" />'">수정</button>
	<button type="submit" onclick="form.action='<c:url value="/memberDel?num=${num}" />'">삭제</button>
